        ...
        <Card className="shadow-2xl">
            ...
            <CardFooter className="flex-col gap-2">
                ...
                <Link href={"/forge"} className="w-full">
                    <Button className="w-full bg-orange-300/10 border border-orange-300/20 hover:bg-accent hover:text-accent-foreground font-bold text-card-foreground"><GiAnvilImpact />Explore {char.btnTitle}</Button>
                </Link>
