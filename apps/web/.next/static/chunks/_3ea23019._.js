...
function buildSelectionsFromForm(formData, existing) {
    var _existing_choices;
    return {
        race: coerceOptionalString(formData.race),
        subrace: coerceOptionalString(formData.subrace),
        choices: (_existing_choices = existing === null || existing === void 0 ? void 0 : existing.choices) !== null && _existing_choices !== void 0 ? _existing_choices : {}
    };
}
function formDataToStoredCharacter(formData, id, type, system) {
    let modifiers = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : [], existingSelections = arguments.length > 5 ? arguments[5] : void 0;
    const processedForm = {
        ...formData
    };
...
const createStoredCharacter = (formData, type, system)=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$character$2f$characterAdapter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["formDataToStoredCharacter"])(formData, id, type, system, modifiers, selections);
};
function rebuildCharacterFromForm(char, formData) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$character$2f$characterAdapter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["formDataToStoredCharacter"])(formData, char.id, char.type, char.system, modifiers, selections);
}
...
//# sourceMappingURL=_3ea23019._.js.map