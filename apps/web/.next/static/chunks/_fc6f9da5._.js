...
"[project]/apps/web/presets/dnd/modifiers.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "exampleClassModifiers": ()=>exampleClassModifiers,
    "exampleRaceModifiers": ()=>exampleRaceModifiers,
    "getDefaultModifiersForCreation": ()=>getDefaultModifiersForCreation
});
const exampleRaceModifiers = [
    {
        id: "race-human-str",
        stat: "strength",
        operation: "add",
...
function getDefaultModifiersForCreation() {
    return [
        ...exampleRaceModifiers,
        ...exampleClassModifiers
    ];
}
...
const dndCharacterSchema = {
    ...
    player: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        level: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].coerce.number().optional(),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$domain$2f$src$2f$stats$2f$statKey$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/domain/src/stats/statKey.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$character$2f$characterAdapter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/character/characterAdapter.ts [app-client] (ecmascript)");
;
;
;
...
function getResolvedStatDisplay(props, system) {
    ...
    const resolved = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$character$2f$characterAdapter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getResolvedStatsForCharacter"])(props);
...
function readCombatStatFromForm(data, combat) {
...
function buildBaseStatsFromForm(attributes, combatFields, system) {
    const config = getPresetStatConfig(system);
    ...
    for (const combat of config.combatStats){
        ...
        stats[combat.statKey] = (_readCombatStatFromForm = readCombatStatFromForm(combatFields, combat)) !== null && _readCombatStatFromForm !== void 0 ? _readCombatStatFromForm : combat.defaultValue;
    }
    return stats;
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
"[project]/apps/web/lib/character/characterAdapter.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
function formDataToBaseStats(data, system) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$character$2f$presetStats$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildBaseStatsFromForm"])(data.attributes, data, system);
}
function formDataToCharacterProps(data, id, type, system) {
...
function syncBaseStatsFromForm(existing, data, system) {
    var _data_name;
    return {
        ...existing,
        name: (_data_name = data.name) !== null && _data_name !== void 0 ? _data_name : existing.name,
        baseStats: formDataToBaseStats(data, system)
    };
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$presets$2f$dnd$2f$modifiers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/presets/dnd/modifiers.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$character$2f$characterAdapter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/character/characterAdapter.ts [app-client] (ecmascript)");
;
;
;
...
function ensureDomainFields(char) {
    if (char.baseStats && char.modifiers) {
        return char;
    }
    const formData = toFormData(char);
    var _char_modifiers;
    const domainProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$character$2f$characterAdapter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formDataToCharacterProps"])(formData, char.id, char.type, char.system, (_char_modifiers = char.modifiers) !== null && _char_modifiers !== void 0 ? _char_modifiers : []);
    var _char_baseStats, _char_modifiers1;
    return {
        ...char,
        baseStats: (_char_baseStats = char.baseStats) !== null && _char_baseStats !== void 0 ? _char_baseStats : domainProps.baseStats,
        modifiers: (_char_modifiers1 = char.modifiers) !== null && _char_modifiers1 !== void 0 ? _char_modifiers1 : domainProps.modifiers
    };
}
...
const createStoredCharacter = (data, type, system)=>{
    const id = crypto.randomUUID();
    var _maxHp;
    const processedData = {
        ...data,
        maxHp: (_maxHp = data.maxHp) !== null && _maxHp !== void 0 ? _maxHp : data.hp
    };
    const domainProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$character$2f$characterAdapter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formDataToCharacterProps"])(toFormData(processedData), id, type, system, (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$presets$2f$dnd$2f$modifiers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultModifiersForCreation"])());
    return {
        id,
        type,
        system,
...
const useCharacterStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])()((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persist"])((set, get)=>({
        characters: [],
        addCharacter: (data, type, system)=>set((state)=>({
                    characters: [
                        ...state.characters,
                        createStoredCharacter(data, type, system)
                    ]
                })),
        ...
        updateCharacter: (id, updatedData)=>set((state)=>({
                    characters: state.characters.map((char)=>{
                        ...
                        const props = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$character$2f$characterAdapter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["syncBaseStatsFromForm"])(storedCharacterToProps(merged), toFormData(merged), merged.system);
                        return {
                            ...merged,
        ...
        updateHp: (id, amount)=>set((state)=>({
                    characters: state.characters.map((char)=>{
                        var _char_hp, _char_maxHp;
                        return char.id === id ? {
                            ...char,
                            hp: Math.max(0, Math.min(((_char_hp = char.hp) !== null && _char_hp !== void 0 ? _char_hp : 0) + amount, (_char_maxHp = char.maxHp) !== null && _char_maxHp !== void 0 ? _char_maxHp : 0))
                        } : char;
                    })
                })),
        getResolvedStats: (id)=>{
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$character$2f$characterAdapter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getResolvedStatsForCharacter"])(storedCharacterToProps(char));
        },
    ...
    merge: (persisted, current)=>{
        ...
        return {
            ...current,
            characters: state.characters.map((char)=>ensureDomainFields(char))
        };
    }
}));
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
function IniciativeCard(param) {
    ...
    const updateHp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$store$2f$useCharacterStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCharacterStore"])({
        "IniciativeCard.useCharacterStore[updateHp]": (state)=>state.updateHp
    }["IniciativeCard.useCharacterStore[updateHp]"]);
    let borderColor = "";
    let textColor = "";
    let backgroundColor = "";
...
_s(IniciativeCard, "nYQbJM5NbYdH+D7lVI5la8J0He4=", false, function() {
    return [
...
//# sourceMappingURL=_fc6f9da5._.js.map