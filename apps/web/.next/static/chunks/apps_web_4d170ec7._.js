...
"[project]/apps/web/app/characters/player/edit/[id]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function EditPlayer() {
    ...
    const id = params.id;
    const updateCharacter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$store$2f$useCharacterStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCharacterStore"])({
        "EditPlayer.useCharacterStore[updateCharacter]": (state)=>state.updateCharacter
    }["EditPlayer.useCharacterStore[updateCharacter]"]);
    const getFormDefaults = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$store$2f$useCharacterStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCharacterStore"])({
        "EditPlayer.useCharacterStore[getFormDefaults]": (state)=>state.getFormDefaults
    }["EditPlayer.useCharacterStore[getFormDefaults]"]);
    const characters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$store$2f$useCharacterStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCharacterStore"])({
        "EditPlayer.useCharacterStore[characters]": (state)=>state.characters
    }["EditPlayer.useCharacterStore[characters]"]);
    const character = characters.find((c)=>c.id === id);
    if (!character) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
        children: "Character not found"
    }, void 0, false, {
        fileName: "[project]/apps/web/app/characters/player/edit/[id]/page.tsx",
        lineNumber: 22,
        columnNumber: 28
    }, this);
    const formDefaults = getFormDefaults(id);
    if (!formDefaults) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
        children: "Character not found"
    }, void 0, false, {
        fileName: "[project]/apps/web/app/characters/player/edit/[id]/page.tsx",
        lineNumber: 25,
    ...
    const presetData = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$presets$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["presets"][characterSystem].presetData;
    const schema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$schema$2f$zodDynamic$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createDynamicSchema"])(presetData.characters.schema, character.type);
    const fields = [
        ...presetData.characters.fields.common,
        ...presetData.characters.fields[character.type] || []
    ];
...
_s(EditPlayer, "6mPFvLLvihUHNOGYeCRptYOnasY=", false, function() {
    return [
...
_c = EditPlayer;
var _c;
__turbopack_context__.k.register(_c, "EditPlayer");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=apps_web_4d170ec7._.js.map