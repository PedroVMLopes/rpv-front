...
"[project]/apps/web/presets/dnd/modifiers.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const dndAbilityFieldAttributes = dndStatConfig.abilities.map(({ name, label })=>({
        name,
        label
    }));
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$domain$2f$src$2f$stats$2f$statKey$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/domain/src/stats/statKey.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$character$2f$characterAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/character/characterAdapter.ts [app-ssr] (ecmascript)");
;
;
;
...
function getResolvedStatDisplay(props, system) {
    ...
    const resolved = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$character$2f$characterAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getResolvedStatsForCharacter"])(props);
...
function buildBaseStatsFromForm(attributes, combatFields, system) {
    ...
    for (const combat of config.combatStats){
        stats[combat.statKey] = readCombatStatFromForm(combatFields, combat) ?? combat.defaultValue;
    }
    return stats;
}
}),
"[project]/apps/web/lib/character/characterAdapter.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function formDataToBaseStats(data, system) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$character$2f$presetStats$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["buildBaseStatsFromForm"])(data.attributes, data, system);
}
function formDataToCharacterProps(data, id, type, system, modifiers = []) {
    return {
        id,
        type,
        name: data.name,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$presets$2f$dnd$2f$modifiers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/presets/dnd/modifiers.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$character$2f$characterAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/character/characterAdapter.ts [app-ssr] (ecmascript)");
;
;
;
...
function ensureDomainFields(char) {
    ...
    const domainProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$character$2f$characterAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formDataToCharacterProps"])(formData, char.id, char.type, char.system, char.modifiers ?? []);
    return {
        ...char,
...
const createStoredCharacter = (data, type, system)=>{
    ...
    const domainProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$character$2f$characterAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formDataToCharacterProps"])(toFormData(processedData), id, type, system, (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$presets$2f$dnd$2f$modifiers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDefaultModifiersForCreation"])());
    return {
        id,
        type,
        system,
...
const useCharacterStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])()((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["persist"])((set, get)=>({
        ...
        updateCharacter: (id, updatedData)=>set((state)=>({
                    characters: state.characters.map((char)=>{
                        ...
                        const props = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$character$2f$characterAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["syncBaseStatsFromForm"])(storedCharacterToProps(merged), toFormData(merged), merged.system);
                        return {
                            ...merged,
        ...
        updateHp: (id, amount)=>set((state)=>({
                    characters: state.characters.map((char)=>char.id === id ? {
                            ...char,
        ...
        getResolvedStats: (id)=>{
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$character$2f$characterAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getResolvedStatsForCharacter"])(storedCharacterToProps(char));
        },
...
function IniciativeCard({ character }) {
    ...
    const updateHp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$store$2f$useCharacterStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCharacterStore"])((state)=>state.updateHp);
    let borderColor = "";
    let textColor = "";
    let backgroundColor = "";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c4544d12._.js.map