...
function optionToGrant(option, grant, source, index) {
    const kind = option.optionType === "spell" ? "spell" : option.optionType === "language" ? "language" : "proficiency";
    return {
...
const createStoredCharacter = (formData, type, system)=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$character$2f$characterAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["formDataToStoredCharacter"])(formData, id, type, system, modifiers, selections, grants);
};
function rebuildCharacterFromForm(char, formData) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$character$2f$characterAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["formDataToStoredCharacter"])(formData, char.id, char.type, char.system, modifiers, selections, grants);
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9b3ac076._.js.map